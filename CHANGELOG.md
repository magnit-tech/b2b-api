...
## v0.1.37 - 26-01-23
- Удалены методы Magnit Post и Last Mile

## v0.1.36 - 26-01-20
- Изменено описание части свойств в запросе создания ску.

## v0.1.35 - 25-12-09
- Добавлено свойство для управления отправкой товаров на ФС (send_to_photo_studio) в запросе создания ску.
